...
test("@smoke Testing environment variables", async ({ page }) => {
...
test("@smoke Bypass authentication by enconing the credentials base64 format", async ({
  page,
}) => {
  let encoddeCredentials = Buffer.from(
